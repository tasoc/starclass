...
# -*- coding: utf-8 -*-
"""
Kepler Q9 Training Set (version 3), 90 day version.
...
#--------------------------------------------------------------------------------------------------
class keplerq9v3_long(TrainingSet):
	"""
	Kepler Q9 Training Set (version 3), 90 day version.
	...
	def __init__(self, *args, datalevel='corr', **kwargs):
		...
		if datalevel != 'corr':
			raise ValueError("The KeplerQ9v3-long training set only as corrected data. Please specify datalevel='corr'.")
...
class keplerq9v3_long_instr(TrainingSet):
	"""
	Kepler Q9 Training Set (version 3), 90 day version, including instrumental class.

	.. codeauthor:: Rasmus Handberg <rasmush@phys.au.dk>
	"""
	# Class constants:
	key = 'keplerq9v3-long-instr'
	_todo_name = 'todo-instr'
	datadir = 'keplerq9v3-long'
